...
/*
   ...
   NOTE: PID/controller and GUI unchanged. Only this file was modified.
*/
...
// Attach channels (swap CH1↔CH3 so 6<->4 are driven correctly)
...
void Motors_update(float dt){
  ...
  // Per-motor cap (scale if any exceeds)
